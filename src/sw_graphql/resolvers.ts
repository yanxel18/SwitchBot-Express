...
const resolvers = {
  Query: {
    ...
    MachineViewList: async (
      _: any,
      __: any,
      { UserAPI, ControlPanelAPI, Token }: Context
    ): Promise<Models.Machine[] | []> => {
    ...
    Machine: async (
      _: any,
      args: Models.MachineArg,
      { SwitchbotAPI, Token, UserAPI }: Context
    ): Promise<Models.MachineList | undefined | []> => {
      return (await UserAPI.UserTokenValidate(Token))
        ? (await SwitchbotAPI.getMachineListForTriggerQ()).find(
            (x) => x.machineID === args.id
          )
        : [];
    },
    MachineSelect: async (
    ...
    SwitchBot: async (
      ...
      if (filter?.switchbotID)
        return (
          sblist?.filter((x) => x.switchbotID === filter.switchbotID) || null
        );
      if (filter?.switchbotRaspiIDisNull)
        return sblist?.filter((x) => x.switchbotRaspiID !== null) || null;
      return (await UserAPI.UserTokenValidate(Token)) && t && Token
        ? ControlPanelAPI.getSwitchbotListQ()
        : null;
    },
    EventMsg: async (
      _: any,
      ...
      return (await SwitchbotAPI.TokenValidate(Token))
        ? await SwitchbotAPI.getEventMSGQ()
        : null;
    },
    LastEvent: async (
      _: any,
      ...
      return t ? await SwitchbotAPI.getMachineLastEventQ(t.mID) : null;
    },
    WorkerList: async (
      _: any,
      ___: any,
      { SwitchbotAPI, ControlPanelAPI, Token }: Context
    ): Promise<Models.WorkerInfo[]> => {
      const t = SwitchbotAPI.TokenDecode(Token);
      return (await SwitchbotAPI.TokenValidate(Token)) && t && Token
        ? ControlPanelAPI.getWorkerListQ()
        : [];
    },
    WorkerViewList: async (
      _: any,
      ___: any,
      { UserAPI, ControlPanelAPI, Token }: Context
    ): Promise<Models.WorkerInfo[]> => {
    ...
    AccountInfo: async (
      ...
      if ((await UserAPI.UserTokenValidate(Token)) && t && Token) {
        const x = (await ControlPanelAPI.getWorkerListQ())?.filter(
          (x) => x.ID === t.uid
        );
        return x;
      }
    ...
    EventMsgList: async (
      ...
      return UserAPI.UserTokenDecode(Token)
        ? await SwitchbotAPI.getEventMSGListQ()
        : null;
    },
    TerminalList: async (
      _: any,
      ___: any,
      { UserAPI, ControlPanelAPI, Token }: Context
    ): Promise<Models.Terminal[]> => {
      const t = UserAPI.UserTokenDecode(Token);
      return (await UserAPI.UserTokenValidate(Token)) && t && Token
        ? ControlPanelAPI.getTerminalsQ()
        : [];
    },
    TerminalListView: async (
      _: any,
      ___: any,
      { SwitchbotAPI, ControlPanelAPI, Token }: Context
    ): Promise<Models.Terminal[]> => {
    ...
    TerminalListEvents: async (
      _: any,
      { filter }: Models.TerminalMsgIDFilter,
      { SwitchbotAPI, ControlPanelAPI, Token }: Context
    ): Promise<Models.TerminalEvents[]> => {
      const t = SwitchbotAPI.TokenDecode(Token);

      const eventListValue =
        (await SwitchbotAPI.TokenValidate(Token)) && t && Token
          ? await ControlPanelAPI.getTerminalEventsQ(filter.lang)
          : [];
      return filter.termAction
        ? eventListValue.filter(
            (x) =>
              x.termID === filter.termID && x.termAction === filter.termAction
          )
        : eventListValue.filter(
            (x) =>
              x.termID === filter.termID && x.termAction === filter.termAction
    ...
    TerminalEvents: async (
      ...
      const t = UserAPI.UserTokenDecode(Token);
      const eventListValue =
        (await UserAPI.UserTokenValidate(Token)) && t && Token
          ? await ControlPanelAPI.getTerminalEventsQ(filter.lang)
          : [];
      return filter.termAction
        ? eventListValue.filter(
            (x) => x.termID === filter.termID && x.termAction !== 1
          )
        : eventListValue.filter((x) => x.termID === filter.termID);
    },
  },
  Mutation: {
    createEventLogs: async (
      _: any,
      args: Models.ArgsInput,
      { SwitchbotAPI, Token }: Context
    ): Promise<string | null> => {
      const t = SwitchbotAPI.TokenDecode(Token);
      return (await SwitchbotAPI.TokenValidate(Token)) && t && Token
        ? await SwitchbotAPI.createEventLogsQ(args.input, t, Token)
        : null;
    },
    createEventLogsHold: async (
      _: any,
      args: Models.ArgsInput,
      { SwitchbotAPI, Token }: Context
    ): Promise<string | null> => {
      const t = SwitchbotAPI.TokenDecode(Token);
      return (await SwitchbotAPI.TokenValidate(Token)) && t && Token
        ? await SwitchbotAPI.createEventLogsQHold(args.input, t)
        : null;
    },
    WorkerToken: async (
      _: any,
      args: Models.machineQR,
      { SwitchbotAPI }: Context
    ): Promise<string | null | Models.WorkerToken> => {
      return await SwitchbotAPI.getQRInfoQ(args);
    },
    createSwitchBot: async (
      _: any,
      args: Models.SwitchbotArgs,
      { ControlPanelAPI, UserAPI, Token }: Context
    ): Promise<string | null> => {
      const t = UserAPI.UserTokenDecode(Token);
      if ((await UserAPI.UserTokenValidate(Token)) && t && Token) {
        const x = (await ControlPanelAPI.getSwitchbotListQ())?.find(
          (x) => x.switchbotMac === args.input.switchbotMac
        );
        return x
          ? "duplicate"
          : await ControlPanelAPI.createSwitchBotQ(args.input, t);
      }
      return null;
    },
    deleteSwitchBot: async (
      _: any,
      args: Models.SwitchbotDeleteArgs,
      { ControlPanelAPI, UserAPI, Token }: Context
    ): Promise<string | null> => {
      const t = UserAPI.UserTokenDecode(Token);
      if ((await UserAPI.UserTokenValidate(Token)) && t && Token) {
    ...
    createMachine: async (
      _: any,
      args: Models.CreateMachineArgs,
      { ControlPanelAPI, UserAPI, Token }: Context
    ): Promise<string | null> => {
      const t = UserAPI.UserTokenDecode(Token);
      if ((await UserAPI.UserTokenValidate(Token)) && t && Token) {
        const a = (await ControlPanelAPI.getMachineListQ())?.filter(
          (b) =>
            b.machineName === args.input.machineName &&
    ...
    createTabletEvent: async (
      _: any,
      args: Models.TabletEventsArgs,
      { ControlPanelAPI, UserAPI, Token }: Context
    ): Promise<string | null> => {
      const t = UserAPI.UserTokenDecode(Token);
      if ((await UserAPI.UserTokenValidate(Token)) && t && Token) {
    ...
    updateMachine: async (
      ...
      if ((await UserAPI.UserTokenValidate(Token)) && t && Token) {
        const a = (await ControlPanelAPI.getMachineListQ())
          ...
          ?.filter(
            (c) =>
              c.machineName === args.input.machineName &&
    ...
    createAccount: async (
      _: any,
      args: Models.CreateAccountArgs,
      { ControlPanelAPI, UserAPI, Token }: Context
    ): Promise<string | null> => {
      const t = UserAPI.UserTokenDecode(Token);
      if ((await UserAPI.UserTokenValidate(Token)) && t && Token) {
        const x = (await ControlPanelAPI.getWorkerListQ())?.find(
          (x) => x.GIDFull === args.input.GIDFull
        );
    ...
    accessInfo: async (
      _: any,
      args: Models.LogInfoArgs,
      { UserAPI }: Context
    ): Promise<Models.AccessInfo | null | string> => {
  ...
  Machine: {
    RaspiList: async (
      parent: Models.MachineArg,
      _: any,
      { SwitchbotAPI }: Context
    ): Promise<Models.Raspi[]> => {
      const { raspiID } = parent;
      return (await SwitchbotAPI.getRaspiQ()).filter(
        (x) => x.raspiID === raspiID
      );
    },
  },
  SwitchBot: {
    RaspiList: async (
      parent: Models.SwitchBot,
      _: any,
      { SwitchbotAPI }: Context
    ): Promise<Models.Raspi[]> => {
      const { switchbotRaspiID } = parent;
      return (await SwitchbotAPI.getRaspiQ()).filter(
        (x) => x.raspiID === switchbotRaspiID
      );
    },
  },
};
